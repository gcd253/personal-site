...
{/* I want this download button to animate and I will use it to learn CSS animations
 ...
 download>
                <span className="font-bold text-3xl group-hover:text-red-500 duration-100">D</span>
                <span className="font-bold text-3xl group-hover:text-red-500 duration-200">O</span>
                <span className="font-bold text-3xl group-hover:text-red-500 duration-300">W</span>
                <span className="font-bold text-3xl group-hover:text-red-500 duration-[400ms]">N</span>
                <span className="font-bold text-3xl group-hover:text-red-500 duration-500">L</span>
                <span className="font-bold text-3xl group-hover:text-red-500 duration-[600ms]">O</span>
                <span className="font-bold text-3xl group-hover:text-red-500 duration-700">A</span>
                <span className="font-bold text-3xl group-hover:text-red-500 duration-[800ms]">D</span>
            </a>
